 ...
 ***/
package github.seanlinwang.sample.stockvalue;
...
public abstract class AbstractNAV {
	...
	public static Map<String, Integer> readTickers() throws IOException {
		final BufferedReader reader = new BufferedReader(new FileReader(AbstractNAV.class.getResource("stocks.txt").getFile()));
